...
.else
	...
	.align $400	
.endif
fnt		ins "data\pic.fnt"
fnt2	ins "data\text.fnt"
scr		ins "data\pic.scr"
scr2	ins "data\text.scr"

ant	dta $44,a(scr)
	dta $04,$04,$04,$04,$84,$04,$04,$84,$04,$84,$04,$04,$04,$84,$84,$04
...
s0	lda #0
	...
	lda s0+1
	bne ch
	mva #>fnt2 dli_start.fn0+1
	jmp go
ch	adb dli_start.fn0+1 #4
	adw g0+1 #80
go	ldx #79
g0	lda scr2,x
	sta scr+(13*40),x
...
trans 	ins '18_go_to_vscorl_p1.obx.bc'
